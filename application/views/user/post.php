...
<body>
	<div id="header">
		<div class="clearfix">
			...
			<ul class="navigation">
				<li >
					<a href="<?php echo site_url();?>/C_home">Home</a>
				</li>
				<li>
					<a href="<?php echo site_url();?>/C_home/about">About</a>
				</li>
				<li>
					<a href="<?php echo site_url();?>/C_home/practices">Practices</a>
				</li>
				<li>
					<a href="<?php echo site_url();?>/C_home/lawyers">Our Lawyers</a>
				</li>
				<li>
					<a href="<?php echo site_url();?>/C_home/news">News</a>
					<div>
						<a href="<?php echo site_url();?>/C_home/singlepost">News Single Post</a>
					</div>
				</li>
				<li>
					<a href="<?php echo site_url();?>/C_home/contact">Contact</a>
				</li>
			</ul>
		</div>
	</div>
	<div id="contents">
		<div class="clearfix">
			...
			<div class="main">
				...
				<div class="frame3">
					<div class="box">
						<img src="<?php echo base_url(); ?>/resources/images/laughing.jpg" alt="Img" height="199" width="584">
					</div>
				</div>
				<p>
