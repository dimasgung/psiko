	...
	<div id="header">
		<div class="clearfix">
			...
			<ul class="navigation">
				...
				<li>
					<a href="<?php echo site_url();?>/home/lawyers">Our Lawyers</a>
				</li>
				<li>
					<a href="<?php echo site_url();?>/home/news">News</a>
					<div>
						<a href="<?php echo site_url();?>/home/singlepost">News Single Post</a>
					</div>
				</li>
				<li>
